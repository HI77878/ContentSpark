...
try:
    ...
    from analyzers.composition_analysis_light import CompositionAnalysisLight
    from analyzers.visual_effects_light_fixed import VisualEffectsLightFixed
...
ML_ANALYZERS = {
    ...
    'composition_analysis': CompositionAnalysisLight,
    'visual_effects': VisualEffectsLightFixed,
